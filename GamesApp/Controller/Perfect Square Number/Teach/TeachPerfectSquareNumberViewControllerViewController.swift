//
//  TeachPerfectSquareNumberViewControllerViewController.swift
//  GamesApp
//
...
class TeachPerfectSquareNumberViewControllerViewController: UIViewController {
    ...
    func createTitleLabel(){
        ...
        titleLabel.text          = "Tam Kare Sayılar"
    ...
    func createTeachingDescriptionLabel(){
        ...
        teachingDescriptionLabel.text = "Merhaba! Bugün sana tam kare sayıları nasıl bulabileceğini öğreteceğim. Tam kare sayılar, bir sayının karekökünün tam bir sayı olduğu sayılardır. Yani, bir sayının karekökü tam sayı ise, o sayı bir tam kare sayıdır."
    ...
    func createApplyDescriptionLabel(){
        ...
        applyDescriptionLabel.text          = "Şimdi, bir sayının tam kare olup olmadığını nasıl kontrol edebileceğimize birlikte bakalım.\n\n Örneğin, 36 sayısını ele alalım. \n Adım 3: Kontrol edelim 36 sayısının karekökünü hesaplayalım: √36 = 6"
    ...
    func createCheckDescriptionLabel(){
        ...
        chechDescriptionLabel.text          = "Sonuç olarak, 36 bir tam kare sayıdır, çünkü karekökü olan 6 tam bir sayıdır."
    ...
    @objc func clickNext(){
        ...
        let vc = PerfectSquareNumberViewController()
