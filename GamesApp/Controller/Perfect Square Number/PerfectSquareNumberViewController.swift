//
//  PerfectSquareNumberViewController.swift
//  GamesApp
//
...
class PerfectSquareNumberViewController: UIViewController {
    ...
    func createTitleLabel(){
        ...
        titleLabel.text          = "Tam kare sayıları seçiniz!"
    ...
    @objc func clickButton(_ sender: UIButton){
        ...
        if sender.tag == 0{
            ...
            let vc = PerfectSquareNumberWebViewController()
            ...
            let vc = TeachPrimeNumberViewController()
...
extension PerfectSquareNumberViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let isPerfect = self.isPerfectSquare(number: self.numberArray[indexPath.row])
