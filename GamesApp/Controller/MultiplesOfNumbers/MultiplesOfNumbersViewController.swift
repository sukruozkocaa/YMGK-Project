//
//  multiplesOfNumbersViewController.swift
//  GamesApp
//
...
class MultiplesOfNumbersViewController: UIViewController {
    ...
    func createTitleLabel(){
        ...
        titleLabel.text          = "9'un katı olan sayıları seçiniz!"
    ...
    @objc func clickButton(_ sender: UIButton){
        ...
        if sender.tag == 0{
            ...
            let vc = MultiplesOfNumbersWebViewViewController()
            ...
            let vc = TeachPerfectSquareNumberViewControllerViewController()
...
extension MultiplesOfNumbersViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if self.numberArray[indexPath.row] % 9 == 0{
